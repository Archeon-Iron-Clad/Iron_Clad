...
/**
 * Visual-only export: draws black rectangles on top of existing PDF content.
 * Underlying text operators are NOT removed — use release export when available.
 */
export async function exportVisualRedactionPreview(
